 ...
 *******************************************************************************/
package org.eclipse.acceleo.module.Rds2Text.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/acceleo/module/Rds2Text/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(MyRdsPackage.class)) {
        	// The normal package registration if your metamodel is in a plugin.
        	resourceSet.getPackageRegistry().put(MyRdsPackage.eNS_URI, MyRdsPackage.eINSTANCE);
        	}
    ...
    public void registerResourceFactories(ResourceSet resourceSet) {
        ...
        put("rds", new XMIResourceFactoryImpl());
    }
